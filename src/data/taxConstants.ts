export const TAX_CONSTANTS_2026 = {
  ...
  CPP: {
    ...
    RATE: 0.0595,
    EXEMPT: 3500,
    MONTHLY_INCREASE: 0.007,
    ANNUAL_INCREASE: 0.084,
  },
  CPP2: {
    YAMPE: 85000,
    RATE: 0.04,
  ...
  EI: {
    MAX_INSURABLE: 68900,
    RATE: 0.0163,
    EMPLOYER_RATE: 0.0232,
  },
  DIVIDENDS: {
    NON_ELIGIBLE_GROSSUP: 1.15,
    ELIGIBLE_GROSSUP: 1.38,
    FEDERAL_CREDIT_RATE: 0.09,
    ON_PROVINCIAL_RATE: 0.0506,
    BC_PROVINCIAL_RATE: 0.046,
  },
  CCB: {
  ...
  BPA: {
    FEDERAL: 16452,
    REDUCTION_START: 181440,
    REDUCTION_FLOOR: 258482,
    MAX_REDUCTION: 0.15,
  },
  MEDICAL: {
    FLOOR_RATE: 0.03,
  ...
  CAPITAL_GAINS: {
    INCLUSION_RATE_1: 0.50,
    INCLUSION_RATE_2: 0.6667,
    THRESHOLD: 250000,
  },
  GST_HOUSING: {
    FULL_REBATE_MAX: 1000000,
    PARTIAL_REBATE_MAX: 1500000,
    RATE: 0.05,
  },
  MHRTC: {
    RATE: 0.15,
